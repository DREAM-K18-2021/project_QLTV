    ...
    <div class="content">
        <div class="home-page__products">
            ...
            <div class="create-book">
                <a class="btn-book" href="{{url('add/theloai')}}">Thêm thể loại</a>
            </div>
        </div>
            ...
            <table class="table table-bordered">
                ...
                @foreach($Tbl_theloai as $key => $tl)
                    ...
                    <tr>
                        ...
                        <td>{{$key + 1}}</td>
                        <td>{{$tl -> theloai}}</td>
                        <td><a class="btn btn-info" href="{{Url('/')}}/edit/chinhsuatheloai/{{$tl->id}}">Chỉnh sửa</a>
                        </td>
                        <td>
                            <form action="/delete/theloai/{{$tl -> id}}" method="post"
                            ...
                            {{--                        <button type="button" class="btn center btn_book btn-danger delete_book-items">Xóa</button>--}}
                            ...
                            {{--                                    </div>--}}
                            {{--                                    <div>--}}
                            {{--                                        <form action="/delete/theloai/{{$tl -> id}}" method="post" onsubmit="return ConfirmDelete( this )">--}}
                            {{--                                            @method('DELETE')--}}
                            {{--                                            @csrf--}}
