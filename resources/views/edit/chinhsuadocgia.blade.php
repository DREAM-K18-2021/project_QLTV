...
<div class="container-fluid">
    ...
    <div class="content">
        <div class="edit_user">
            <form action="/edit-docgia/{{$Tbl_editdocgia->id}}" method="post">
                @csrf
                <h2>Chỉnh sửa độc giả</h2>
                <div class="_card--form">
                    <div class="input-contact">
                        <label>
                            <input type="text" name="tendocgia" value="{{$Tbl_editdocgia->tendocgia}}">
                            <section>
                                Tên độc giả
                            </section>
                        </label>
                    ...
                    <div class="input-contact">
                        <label>
                            <input type="text" name="madocgia" value="{{$Tbl_editdocgia->madocgia}}">
                            <section>
                                Mã độc giả
                            </section>
                        </label>
                    ...
                    <div class="input-contact">
                        <label>
                            <input type="text" name="lop" value="{{$Tbl_editdocgia->lop}}">
                            <section>
                                Lớp
                            </section>
                        </label>
                    ...
                    <div class="input-contact">
                        <label>
                            <input type="text" name="sodienthoai" value="{{$Tbl_editdocgia->sodienthoai}}">
                            <section>
                                Số điện thoại
                            </section>
                        </label>
