            ...
            <!--   con = Container  for items in the form-->
                <div class="con">
                    ...
                    <div class="field-set">
                        ...
                        <!--   user name Input-->
                        <input class="form-input" name="name" id="txt-input" type="text" placeholder="@UserName">
                        ...
                        <!--   Password Input-->
                        <input class="form-input" type="password" placeholder="Remember password" id="pwd" name="repassword">
                        ...
                        <!--        buttons -->
                        <!--      button LogIn -->
                        <button class="log-in" type="submit"> Đăng Ký</button>
                    </div>
